            ...
            FragTrap::FragTrap(void)
{
    ...
    std::cout <<  YELLOW "FragTrap " RESET BOLDYELLOW<< this->_name << RESET YELLOW " appeared !\t[Default constructor called]" RESET << std::endl;
    return ;
}
...
{
    *this = src;
    std::cout << CYAN "FragTrap " RESET BOLDCYAN << this->_name << RESET CYAN " appeared !\t[Copy constructor called]" RESET << std::endl;
    return ;
}
            ...
            FragTrap::FragTrap(std::string name)
{
    ...
    std::cout << GREEN "FragTrap " RESET BOLDGREEN<< this->_name << RESET GREEN " appeared !\t[string constructor called]" RESET << std::endl;
    return ;
}
...
void        FragTrap::highFivesGuys(void)
{
    if (this->checkLife() == 0)
    {
        ...
        std::cout << *this;
        std::cout << BOLDGREEN ">>Do you accept " << this->getName() << " high five ? [yes] or [no]" RESET << std::endl << ">>";
        std::cin >> agreement;
        if (agreement == "yes")
            std::cout << BOLDYELLOW ">>FragTrap " << this->getName() << " thanks you for returning his high five.\n" RESET << std::endl;
        else
